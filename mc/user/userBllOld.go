...
//	api.Reg(qf.EKindDelete, "user/deleteUser", u.deleteUser)
...
//
////isExist 判断用户是否已经存在
//func (u *UserBll) isExist(loginId, name string) (UserOld, bool) {
//	for _, user := range u.cache {
//		if user.LoginId == loginId || user.Name == name {
//			return user, true
//		}
//	}
//	return UserOld{}, false
//}
//
////
//// login
...
////  @return *[]UserOld 所有用户列表
////  @return error
////
//func (u *UserBll) GetUsersByIds(uIds []uint) []UserOld {
//	list := make([]UserOld, 0)
//	for _, user := range u.cache {
//		if user.LoginId != "visitor" &&
//			user.LoginId != "admin" &&
