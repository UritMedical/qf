...
//注册部门相关API
func (u *Bll) regDptApi(api qf.ApiMap) {
	//部门
...
func (u *Bll) saveDpt(ctx *qf.Context) (interface{}, error) {
...
func (u *Bll) deleteDpt(ctx *qf.Context) (interface{}, error) {
...
//  @return error
//
func (u *Bll) getDptTree(ctx *qf.Context) (interface{}, error) {
...
//  @return []*DepartNode
//
func (u *Bll) buildTree() []*DepartNode {
	//获取所有部门
...
//  @return error
//
func (u *Bll) addDptUsers(ctx *qf.Context) (interface{}, error) {
	params := struct {
		DepartId uint64
		UserIds  []uint64
	}{}
...
//  @return error
//
func (u *Bll) deleteDptUser(ctx *qf.Context) (interface{}, error) {
...
//  @return error
//
func (u *Bll) getDpts(ctx *qf.Context) (interface{}, error) {
...
//  @return error
//
func (u *Bll) getDptUsers(ctx *qf.Context) (interface{}, error) {
	departId := ctx.GetUIntValue("DepartId")
...
//  @return []uint64
//
func (u Bll) getDptAndSubDptUsers(departId uint64) ([]uModel.User, error) {
...
//递归查找用户
func (u Bll) findChildrenUserIds(uIdMap map[uint64]string, dptNode *DepartNode) {
...
//递归查找部门
func (u Bll) findChildrenDpt(departId uint64, dptNodes []*DepartNode) *DepartNode {
